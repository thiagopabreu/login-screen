...
function Register() {
  ...
  return (
    <div className="background-image d-flex align-items-center mx-auto">
      <Container fluid className="p-0" style={{zIndex: '1'}}>
        <Row className="justify-content-md-center m-5">
            <Col sm={5} className="justify-content-md-center"> 
                <Card style={{width: '50rem', backgroundColor: '#424656'}}  className="pt-5 pb-5 pr-5">
                  <RegisterForm />
                </Card>
            </Col>
        </Row>
